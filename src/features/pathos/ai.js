...
Rules: 3-5 strengths, 3-5 gaps, 2-4 certs, 4-6 milestones (foundational->advanced). Each gap closed by exactly one milestone (gap_closed matches gap.name). Make landmark names reflect their field. Calibrate for the SEA / Malaysian job market.`;
